...
当 interface 本身的 shape 还成问题——module 有多 deep、seam 该放哪、interface 该暴露什么——用 `/codebase-design` skill 取词汇。它是 module、interface、depth、seam、adapter、leverage 与 locality 等术语的共享来源，是要查阅的 reference，不是要跑的 session。
