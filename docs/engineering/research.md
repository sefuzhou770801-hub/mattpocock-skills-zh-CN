...
```bash
npx skills add sefuzhou770801-hub/mattpocock-skills-zh-CN --skill=research
```
...
[Source](https://github.com/sefuzhou770801-hub/mattpocock-skills-zh-CN/tree/main/skills/engineering/research)
